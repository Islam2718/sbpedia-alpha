...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form method="post" action="{{ route('settings.language.update', $languageByIdArray->id) }}">
        @csrf
        <!-- Profile INFO -->
        <div class="card my-3 px-4">
            <h5 class="card-header">Language Edit:)</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-5">
                        <div class="mb-2">
                    ...
                    <div class="col-xl">
                        <div class="mb-2">
                            ...
                            <input name="flag" value="{{ $languageByIdArray->flag }}" type="text" class="form-control" id="flag" placeholder="flag !">
                        </div>
                    </div>
                </div>
                <div class="row">                    
                    <div class="col-xl-9">
                        <div class="mb-2">
                            ...
                            <textarea name="description" rows="4" class="form-control" id="basic-default-fullname" placeholder="Desription !">{{ $languageByIdArray->description }}</textarea>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="mb-2 my-3">
                        ...
                        <div class="mb-2 mt-3">
                            ...
                            <input {{ $languageByIdArray->is_default == '1' ? 'checked' : ''}} type="checkbox" id="is_default" name="is_default" value="1"> 
